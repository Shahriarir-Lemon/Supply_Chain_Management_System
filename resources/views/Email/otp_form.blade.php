    ...
    <div class="container py-5 h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          ...
          <form action="{{ route('post_otp') }}" method="post" class="mb-4">
            @csrf
            <div class="form-outline">
                <input type="text" id="typeEmailX-2" name="otp" class="form-control form-control-lg" />
            </div>
        
            <div class="d-flex justify-content-between align-items-center mt-3">
               
                  <a href="{{ route('resend') }}" style="background: green;" class="btn btn-primary" >Resend</button></a>
