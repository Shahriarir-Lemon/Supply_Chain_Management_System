...
<div class="container">
    <form class="needs-validation" action="{{ route('cus1_place_order') }}" method="POST" novalidate="">
        @csrf
    ...
    @endphp
        ...
        <div class="col-md-4 order-md-2 mb-4">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                ...
                <span style="font-size: 20px;" class="badge badge-primary badge-pill" style="color: white;">{{ $cartcc }} items.</span>
            </h4>
