...
<body>
    ...
    <div class="container py-5" id="Ad">
        ...
        <form  action="{{ route('cus_search') }}" method="GET" style="display: flex; justify-content: center; align-items: center;">
            @csrf
        ...
        <h4 class="text-center" style="margin-left: 10px;color:green;margin-top:12px;">{{ $count }}- items found..</h4>  
