                    ...
                    <table class="table mb-0" style="border:1px solid black;">
                        <thead style="border:1px solid black;">
                            <tr style="border:1px solid black;">
                                ...
                                <th style="border:1px solid black;background:grey;color:white;">Date Pu</th>
                                ...
                                <th style="border:1px solid black;background:grey;color:white;">Delevery Status</th>
                        ...
                        <tbody style="border:1px solid black;">
                            ...
                            <tr style="border:1px solid black;">
                                ...
                                <td><span style="color:red;">Canceled by Admin</span>
