   ...
   <div class="pdf">
    ...
    <div class="container">
        <div class="product_form"><br>
            ...
            <h3 class="mt-0 text-center"><u>All Request From Distributor</u></h3>
                                 ...
                                 <td>
                                   ...
                                   @else
                                    <td >
                                        ...
                                        <a onclick="return confirm('Are You Sure to Approve the Request ? ')" href="{{ route('approve_request',$detail->id) }}"><button class="btn btn-success">Approve</button></a>
                                        <a onclick="return confirm('Are You Sure to Cancel the Request ? ')" href="{{ route('cancel_request',$detail->id) }}"><button class="btn btn-danger">Cancel</button></a>
